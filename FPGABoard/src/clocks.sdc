...
# Set Clock Groups
#**************************************************************
#set_clock_groups -exclusive -group [get_clocks {usb_pll:usb_pll_u|altpll:altpll_component|usb_pll_altpll:auto_generated|wire_pll1_clk[*]}] -group [get_clocks {adc_pll_ext:adc_pll_u|altpll:altpll_component|adc_pll_ext_altpll:auto_generated|wire_pll1_clk[0]}]
set_clock_groups -exclusive -group [get_clocks {usb_pll:usb_pll_u|altpll:altpll_component|usb_pll_altpll:auto_generated|wire_pll1_clk[*]}] -group [get_clocks {adc_pll_ext:adc_pll_u|altpll:altpll_component|adc_pll_ext_altpll1:auto_generated|wire_pll1_clk[0]}]
